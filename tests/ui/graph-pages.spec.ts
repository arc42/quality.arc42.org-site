...
test("quick filter disappears when selected and reappears when removed", async ({
                                                                                    page,
                                                                                }) => {
    await page.setViewportSize({width: 1280, height: 760});
    await page.goto("/full-quality-graph");
...
test("allows up to 10 filters and disables filtering when cap is reached", async ({
                                                                                      page,
                                                                                  }) => {
    await page.setViewportSize({width: 1280, height: 760});
    await page.goto("/full-quality-graph");
