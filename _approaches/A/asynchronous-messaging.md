...
- [Backpressure propagation](/approaches/backpressure-propagation) to slow producers at the source when bounded queues fill, instead of absorbing unbounded backlog.
