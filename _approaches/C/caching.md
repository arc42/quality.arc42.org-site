...
- Under realistic load, [p99](https://en.wikipedia.org/wiki/Percentile) response time for cached endpoints stays below the target threshold (e.g., `< 100 ms`) with a cache hit ratio of at least 80%.
