...
| **Examples**  | <i class="fa fa-bullseye" style="color: var(--req-text-color);"></i>  | These are the specific requirements stakeholders have for a system or product, often expressed in the form of quality scenarios. They should facilitate stakeholder communication by enabling a common understanding of the _good enough_. Q42 provides >50 of these [**examples**](/requirements/) |
| **Acceptance criterion** |   | What does _good enough_ mean with respect to a specific quality. |
| **Approach**  |  <i class="fa fa-puzzle-piece" style="color: var(--approaches-text-color);"></i> | **Under development**, consider this content **_experimental_**: How to achieve one or several qualities.  |
| **Standard**  | <i class="fa fa-award" style="color: var(--standard-text-color);"></i>| Numerous international standards describe/prescribe/care about certain aspects of quality. Important ones are ISO-25000:2023, ISO-27001 or MISRA.  |
