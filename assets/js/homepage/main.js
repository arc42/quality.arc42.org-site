(() => {
  ...
  // src/graphs/HomeGraph.js
  var HomeGraph = class extends Graph2 {
    /**
     * @param {string} containerId - ID of the container element
     * @param {GraphDataProvider} dataProvider - Data provider instance
     */
    constructor(containerId, dataProvider2) {
      super(containerId, "home", dataProvider2);
  ...
  var homeGraph = new HomeGraph("q-graph-container", dataProvider);
